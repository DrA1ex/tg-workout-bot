...
describeWithSilencedConsole('Flow Handler Tests', ['warn', 'error', 'log'], () => {
    ...
    describe('cleanupPendingState', () => {
        ...
        it('should handle missing ctx gracefully', async () => {
            ...
            // Should not crash
            await expect(cleanupPendingState(mockSession)).resolves.not.toThrow();
        });
        ...
        it('should handle null session gracefully', async () => {
            // Should not crash
            await expect(cleanupPendingState(null)).resolves.not.toThrow();
        });
    });
